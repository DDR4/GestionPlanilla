...
namespace WebGestionPlanilla.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel modelView, string returnUrl)
        {
            ...
            if (result.Trabajador.InternalStatus == GestionPlanilla.Common.EnumTypes.InternalStatus.Success)
            {
            ...
            {
                ModelState.AddModelError("", result.Trabajador.InternalException);
            }
        ...
        public async Task SignInAsync(CustomApplicationUser user, bool isPersistent)
        {
            ...
            identity.AddClaim(new Claim("Trabajador_Id", user.Trabajador_Id ?? ""));
